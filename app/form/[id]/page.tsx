...
//           return {
//             fieldLabel: key.replace(/\.\d+$/, ''), // Remove array index
//             value: value.join(', '),
//           };
//         }
//         return {
...
//           </svg>
//           <h3 className="mt-4 text-lg font-medium text-gray-900">Form not found</h3>
//           <p className="mt-2 text-gray-500">The form you're looking for doesn't exist or has been removed.</p>
//         </div>
//       </div>
//     );
//   }
...
//           </svg>
//           <h3 className="mt-4 text-lg font-medium text-gray-900">Form is not available</h3>
//           <p className="mt-2 text-gray-500">This form is currently not published. Please check back later.</p>
//         </div>
//       </div>
//     );
//   }
