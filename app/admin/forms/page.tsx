...
//             <p className="text-gray-500">Manage exams by class</p>
//           </div>
...
//               <div
//                 key={form._id}
//                 className="bg-white p-5 rounded-md shadow-sm flex justify-between"
//               >
//                 {/* Left */}
...
//                   <button onClick={() => copyFormLink(form._id)}>
//                     <RxLink2 />
//                   </button>

//                   <button
//                     onClick={() =>
//                       router.push(`/admin/forms/${form._id}`)
//                     }
//                   >
//                     <RxEyeOpen />
//                   </button>
...
//                     onClick={() =>
//                       router.push(
//                         `/admin/forms/responses/${form._id}`
//                       )
//                     }
//                   >
//                     <FaRegComments />
...
//                   <button
//                     onClick={() =>
//                       deleteForm(form._id, form.title)
//                     }
//                   >
//                     <RxTrash />
//                   </button>
