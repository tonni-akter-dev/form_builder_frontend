...
const FormPreviewPage = () => {
  ...
  const renderField = (field: FormField, index: number) => {
    ...
    return (
      <div key={field._id} className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-start gap-3">
          <span className="text-sm font-medium text-gray-400 min-w-6">
            {index + 1}.
          </span>
  ...
  return (
    <div className="min-h-screen bg-[#F0EBF8] py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Class, Subject, Duration Info */}
        <div className="bg-white rounded-t-lg shadow-sm border-t-8 border-[#673AB7] p-6 mb-3">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pb-4 border-b border-gray-100">
            <div>
              <p className="text-xs text-gray-500">Class</p>
              <p className="text-sm font-medium text-gray-800">{form.className || "-"}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500">Subject</p>
              <p className="text-sm font-medium text-gray-800">{form.subject || "-"}</p>
            </div>
            <div>
              <p className="text-xs text-gray-500">Duration</p>
              <p className="text-sm font-medium text-gray-800">{form.duration || 0} minutes</p>
            </div>
          </div>
        </div>
        ...
        {/* Disabled Submit Button */}
        <div className="mt-3 bg-white rounded-lg shadow-sm p-6">
          <button
            type="button"
            disabled
            className="px-6 py-2 bg-gray-200 text-gray-500 font-medium rounded-lg cursor-not-allowed"
